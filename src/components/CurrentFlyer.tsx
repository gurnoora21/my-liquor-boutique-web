      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-24">
          <h2 className="text-4xl md:text-5xl font-heading font-bold text-white mb-8" style={{ lineHeight: '1.32' }}>
            This Week's <span className="text-warm-gold">Specials</span>
          </h2>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-charcoal p-8 rounded-lg border-2 border-warm-gold/30 hover:border-warm-gold/50 transition-all duration-300">
            <div className="text-center mb-8">
              <div className="w-full h-64 bg-gray-800 rounded-lg flex items-center justify-center mb-8 border border-gray-600">
                <div className="text-center text-gray-400">
                  <Article className="w-16 h-16 mb-4 mx-auto text-warm-gold" />
                  <p className="text-lg font-body" style={{ lineHeight: '1.8' }}>Current Flyer Preview</p>
                  <p className="text-sm font-body" style={{ lineHeight: '1.8' }}>Updated Weekly</p>
                </div>
              </div>
